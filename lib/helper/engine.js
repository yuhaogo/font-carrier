...
fontEngine.parse = (function () {
  ...
  var _parseSvgFont = function (svgBuffer) {
    ...
    _.forEach(fontElem.getElementsByTagName("glyph"), function (glyphElem) {
      ...
      if (!glyph.vertAdvY) {
        glyph.vertAdvY = font.options.vertAdvY
          ? font.options.vertAdvY
          : fontfaceHeight;
      }
    });
...
fontEngine.convert = (function () {
  ...
  return function (options) {
    ...
    if (!inputBuffer) {
      helper.showError(
        "font convert input error,support path,buffer,string.please check if the file exist,while the input is a path."
      );
      return;
    }
